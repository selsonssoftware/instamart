...
// మీ ప్రాజెక్ట్‌లో CartContext లేకపోతే ఈ లైన్‌ను కామెంట్ చేయండి మరియు క్రింద addToCart డమ్మీ ఫంక్షన్ వాడండి.
import { useCart } from './CartContext'; 

const { width } = Dimensions.get('window');

// --- MOCK DATA (విస్తరించిన డేటా) ---
...
export default function FreshFruitsScreen() {
    // Cart Context వాడకపోతే, ఈ లైన్ అన్-కామెంట్ చేయండి:
    // const addToCart = (item) => Alert.alert('Added to cart', item.name);
    const { addToCart } = useCart(); // Context ఉంటే ఇది వాడండి
    ...
    // useMemo వాడటం వల్ల ప్రతి రెండర్‌కు ఈ లాజిక్ రన్ అవ్వదు, డిపెండెన్సీలు మారినప్పుడే రన్ అవుతుంది.
